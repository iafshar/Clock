                          ...
                          if (myRecord.sentByMe == 0) {
                            if (myRecord.Type == 1) { 
                              if (myUserID != myRecord.UserID) { // prevents user from being linked to their own profile page but from another perspective
                                ...
                                if (premium) {
                                  newRow = "<tr class='table-row' style='background-color:"+myRecord.Color+"'><td><table><tr><td><b>"+myRecord.Username+"</b></td></tr><tr><td>"+myRecord.Name+"</td></tr><tr><td><iframe src='Clock_ReadOnlySmall/index.html?1"+myRecord.Content[0]+"' loading='lazy' id='miniClock' width=410 height=205 onload=iframeclick()></iframe><br>"+myRecord.Content[1]+"</td></tr><tr><td><i>"+myRecord.Date+"</i></td></tr><tr><td><strong>Sent</strong><br><i>"+myRecord.DateSent+"</i></td></tr></table></td><td><table><tr><td><button class='viewClock' onclick=openClock('"+myRecord.Content[0]+"')><img border='0' src='Icons/expand.png' width='40' height='40'></button></td><td><button class='changeSound' onclick=changeSound('"+myRecord.Content[0]+"','"+countClocks+"')><img border='0' src='Icons/mute.png' class='sound-icon' width='40' height='40'></button></td><td><button class='sendClock' onclick=sendClock('"+myRecord.Content[0]+"')><img border='0' src='Icons/inbox.png' width='40' height='40'></button></td><td></td></tr><tr><td height=225></td></tr><tr><td><img border='0' src='Icons/like.png' width='40' height='40'></td><td><img border='0' src='Icons/dislike.png' width='40' height='40'></td><tr><td>"+myRecord.NumOfLikes+"</td><td>"+myRecord.NumOfDislikes+"</td></tr></table></td><td><form action='addComment.php' method='post'><table><tr><td height=70></td></tr><tr><td><textarea style='height:195px;width:400px;font-size:30px;' name='comment' placeholder='Comment'></textarea></td></tr><tr><td><input type='hidden' name='Maker' value="+myRecord.Username+"><input type='hidden' name='clockName' value="+myRecord.Name+"><button type='button' class='viewComments' style='width:200px;height:45px;' onclick=openComments('"+myRecord.Content[0]+"')>View All</button><input type='hidden' name='location' value=chat.php><input type='submit' style='width:200px;height:45px;' value='Enter'></td></tr></table></form></td></tr>";
                                } 
                                else {
                            ...
                            if (myRecord.Type == 1) {
                              ...
                              if (myUserID != myRecord.UserID) {
                                ...
                                if (premium) {
                                  newRow = "<tr class='table-row' style='background-color:"+myRecord.Color+"'><td><table><tr><td><b>"+myRecord.Username+"</b></td></tr><tr><td>"+myRecord.Name+"</td></tr><tr><td><iframe src='Clock_ReadOnlySmall/index.html?1"+myRecord.Content[0]+"' loading='lazy' id='miniClock' width=410 height=205 onload=iframeclick()></iframe><br>"+myRecord.Content[1]+"</td></tr><tr><td><i>"+myRecord.Date+"</i></td></tr></table></td><td><table><tr><td><button class='viewClock' onclick=openClock('"+myRecord.Content[0]+"')><img border='0' src='Icons/expand.png' width='40' height='40'></button></td><td><button class='changeSound' onclick=changeSound('"+myRecord.Content[0]+"','"+countClocks+"')><img border='0' src='Icons/mute.png' class='sound-icon' width='40' height='40'></button></td><td><button class='sendClock' onclick=sendClock('"+myRecord.Content[0]+"')><img border='0' src='Icons/inbox.png' width='40' height='40'>"+myRecord.NumOfLikes+"</button></td><td></td></tr><tr><td height=225></td></tr><tr><td><img border='0' src='Icons/like.png' width='40' height='40'></td><td><img border='0' src='Icons/dislike.png' width='40' height='40'>"+myRecord.NumOfDislikes+"</td></table></td><td><form action='addComment.php' method='post'><table><tr><td height=70></td></tr><tr><td><textarea style='height:195px;width:400px;font-size:30px;' name='comment' placeholder='Comment'></textarea></td></tr><tr><td><input type='hidden' name='Maker' value="+myRecord.Username+"><input type='hidden' name='clockName' value="+myRecord.Name+"><button type='button' class='viewComments' style='width:200px;height:45px;' onclick=openComments('"+myRecord.Content[0]+"')>View All</button><input type='hidden' name='location' value=chat.php><input type='submit' style='width:200px;height:45px;' value='Enter'></td></tr><tr><td><strong>Sent</strong><br><i>"+myRecord.DateSent+"</i></td></tr></table></form></td></tr>";
                                } 
                                else {
                                  newRow = "<tr class='table-row' style='background-color:"+myRecord.Color+"'><td><table><tr><td><b>"+myRecord.Username+"</b></td></tr><tr><td>"+myRecord.Name+"</td></tr><tr><td><iframe src='Clock_ReadOnlySmall/index.html?1"+myRecord.Content[0]+"' loading='lazy' id='miniClock' width=410 height=205 onload=iframeclick()></iframe><br>"+myRecord.Content[1]+"</td></tr><tr><td><i>"+myRecord.Date+"</i></td></tr></table></td><td><table><tr><td><button class='viewClock' onclick=openClock('"+myRecord.Content[0]+"')><img border='0' src='Icons/expand.png' width='40' height='40'></button></td><td><button class='changeSound' onclick=changeSound('"+myRecord.Content[0]+"','"+countClocks+"')><img border='0' src='Icons/mute.png' class='sound-icon' width='40' height='40'></button></td><td><button class='sendClock' onclick=sendClock('"+myRecord.Content[0]+"')><img border='0' src='Icons/inbox.png' width='40' height='40'>"+myRecord.NumOfLikes+"</button></td><td></td></tr><tr><td height=225></td></tr><tr><td><img border='0' src='Icons/like.png' width='40' height='40'></td><td><img border='0' src='Icons/dislike.png' width='40' height='40'>"+myRecord.NumOfDislikes+"</td></table></td><td><table><tr><td height=70></td></tr><tr><td><button type='button' class='viewComments' style='width:200px;height:45px;' onclick=openComments('"+myRecord.Content[0]+"')>View Comments</button></td></tr><tr><td><strong>Sent</strong><br><i>"+myRecord.DateSent+"</i></td></tr></table></td></tr>";
                                }
                              }
                              countClocks += 1;
                            }
    ...
    <script>
      function like(clockID) {
        $.ajax({
          ...
          success: function (response) {
            elems = document.getElementsByClassName("likeButton-"+clockID);
            for (let i = 0; i < elems.length; i++) {
              var elem = elems[i];
              inners = elem.innerHTML.split('>')
              if (response == 0) {
                elem.innerHTML = inners[0] + '>' + (Number(inners[1]) - 1);
      ...
      function dislike(clockID) {
        $.ajax({
          ...
          success: function (response) {
            elems = document.getElementsByClassName("dislikeButton-"+clockID);
            for (let i = 0; i < elems.length; i++) {
              var elem = elems[i];
              inners = elem.innerHTML.split('>')
              if (response == 0) {
