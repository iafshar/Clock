...
function setup() {
  ...
  hs1 = new HScrollbar(0, Height-16, Width, 30,2);
    ...
    cymbal = new Circle(cymbalSound, CircleDiameter,20,20, GREEN);
    cymbal2 = new Circle(cymbalSound, CircleDiameter,50,20, GREEN);
    ...
    cymbal6 = new Circle(cymbalSound, CircleDiameter,20,60, GREEN);
    cymbal7 = new Circle(cymbalSound, CircleDiameter,50,60, GREEN);
